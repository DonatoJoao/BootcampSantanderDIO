...
public class TesteSet {
    public static void main(String[] args) {
        ...
        conjuntoConvidados.addConvidado("João", 1234);
        conjuntoConvidados.addConvidado("Pri", 1235);
        conjuntoConvidados.addConvidado("Masha", 1235);
        conjuntoConvidados.addConvidado("Rabisco", 1236);
